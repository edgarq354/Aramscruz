...
//verificar si los datos en la base de datos con su cedula de identidad.
    ...
    public void  aceptar_condiciones()
    {
        ...
        final Button bt_aceptar_continuar= promptView.findViewById(R.id.bt_aceptar_continuar);
        final CheckBox cb_terminos_condiciones= promptView.findViewById(R.id.cb_terminos_condiciones);
