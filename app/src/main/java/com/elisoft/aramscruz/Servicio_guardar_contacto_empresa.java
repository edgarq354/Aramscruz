...
public class Servicio_guardar_contacto_empresa extends IntentService {



    public Servicio_guardar_contacto_empresa() {
        super("Servicio_guardar_contacto_empresa");
    }
    ...
    private void cargar_contacto_empresa() {
        ...
        String MobileNumber = getString(R.string.whatsapp);
        String HomeNumber = getString(R.string.telefono);
        String WorkNumber =getString(R.string.telefono);
        String emailID = getString(R.string.correo);
