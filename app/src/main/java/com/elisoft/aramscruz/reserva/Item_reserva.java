package com.elisoft.aramscruz.reserva;
...
public class Item_reserva  extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView numero_casa= v.findViewById(R.id.tv_numero_casa);
        TextView fecha= v.findViewById(R.id.tv_fecha);
        TextView referencia= v.findViewById(R.id.tv_referencia);
        TextView estado= v.findViewById(R.id.tv_estado);
