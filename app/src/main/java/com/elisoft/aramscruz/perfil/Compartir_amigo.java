    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.bt_invitar:
                ...
                intent1.putExtra(Intent.EXTRA_TEXT, "He usado "+getString(R.string.app_name)+" y es una aplicacion genial para pedir Taxi. Te recomiendo usarlo. Usa el codigo "+ tv_codigo.getText()+" para agregarte un bono en tu Billetera. https://play.google.com/store/apps/details?id=com.elisoft.aramscruz&hl=es");
