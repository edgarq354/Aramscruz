...
public class Constants {
     ...
     */
    public static final String ACTION_RUN_ISERVICE = "com.elisoft.aramscruz.action.RUN_INTENT_SERVICE";
    public static final String ACTION_PROGRESS_EXIT = "com.elisoft.aramscruz.action.PROGRESS_EXIT";
