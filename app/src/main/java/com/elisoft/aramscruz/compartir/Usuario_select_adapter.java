package com.elisoft.aramscruz.compartir;
...
public class Usuario_select_adapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView celular = v.findViewById(R.id.tv_celular);
        final CheckBox cb_seleccionar = v.findViewById(R.id.cb_seleccionar);
