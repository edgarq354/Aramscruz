package com.elisoft.aramscruz.carreras;
...
import com.elisoft.aramscruz.Pedido_perfil_taxi;
...
actualizar();
        ...
        lista_carrera.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    ...
                    hi=carrera.get(i);
                    Intent ee = new Intent(getApplicationContext(), Pedido_perfil_taxi.class);
                    ee.putExtra("id_conductor", String.valueOf(hi.getId_conductor()));
                    ee.putExtra("id_vehiculo", id_vehiculo);
                    startActivity(ee);
                }catch (Exception e)
                {
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK) {
                        ...
                        if (suceso.getSuceso().equals("1")) {
                            ...
                            for (int i = 0; i < usu.length(); i++) {
                                ...
                                cargar_lista_en_carrera( id, latitud_inicio, longitud_inicio, latitud_fin, longitud_fin, monto, distancia, fecha_inicio, fecha_fin, tiempo, id_pedido, id_conductor,ruta);
                            }
    ...
    private void cargar_lista_en_carrera(String id, double latitud_inicio, double longitud_inicio, double latitud_fin, double longitud_fin, double monto, String distancia, String fecha_inicio, String fecha_fin, String tiempo, String id_pedido, String id_usuario, String ruta) {
...
}catch (Exception e)
{
    ...
    public void cargar_carrera_en_la_lista( int id_pedido) {
        ...
        SQLiteDatabase bd = admin.getWritableDatabase();
        Cursor fila = bd.rawQuery("select id,latitud_inicio,longitud_inicio,latitud_fin,longitud_fin,distancia,fecha_inicio,fecha_fin,tiempo,id_pedido,id_conductor,monto,ruta from carrera where id_pedido="+id_pedido+" ORDER BY id ASC ", null);
int numero=1;
        if (fila.moveToFirst()) {  //si ha devuelto 1 fila, vamos al primero (que es el unico)
            ...
            do {
                ...
                CCarrera hi = new CCarrera(id,latitud_inicio,longitud_inicio,latitud_fin,longitud_fin,distancia,fecha_inicio,fecha_fin,tiempo,i_id_pedido,id_conductor,monto,s_ruta, String.valueOf(numero));
