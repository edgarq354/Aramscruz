...
public class CCarrera {
    ...
    public CCarrera(int id, double latitud_inicio, double longitud_inicio, double latitud_fin, double longitud_fin, String distancia, String fecha_inicio, String fecha_fin, String tiempo, int id_pedido, int id_conductor, double monto, String ruta, String numero)    {
        this.id=id;
