package com.elisoft.aramscruz.Buscador;
                            ...
                            public void onResult(PlaceBuffer places) {
                                if(places.getCount()==1){
                                 ...
                                 //   Toast.makeText(getApplicationContext(),String.valueOf(places.get(0).getLatLng()),Toast.LENGTH_SHORT).show();
                                    Intent otra_direccion=new Intent(getApplicationContext(),Otra_direccion.class);
                                    otra_direccion.putExtra("latitud", String.valueOf(places.get(0).getLatLng().latitude));
                                    otra_direccion.putExtra("longitud", String.valueOf(places.get(0).getLatLng().longitude));
                                    otra_direccion.putExtra("description",item.description);
                                    otra_direccion.putExtra("direccion",item.direccion);
                                    startActivity(otra_direccion);
