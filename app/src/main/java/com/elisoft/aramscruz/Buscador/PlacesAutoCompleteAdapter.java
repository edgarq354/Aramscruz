...
public class PlacesAutoCompleteAdapter
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
        ...
        mPredictionHolder.mDireccion.setText(mResultList.get(i).direccion);
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder {
        ...
        public PredictionHolder(View itemView) {
            ...
            mDireccion = itemView.findViewById(R.id.direccion);
    ...
    public class PlaceAutocomplete {
        ...
        PlaceAutocomplete(CharSequence placeId, CharSequence description, CharSequence direccion) {
