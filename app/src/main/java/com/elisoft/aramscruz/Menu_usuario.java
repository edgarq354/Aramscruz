...
import com.elisoft.aramscruz.perfil.Billetera;
import com.elisoft.aramscruz.perfil.Compartir_amigo;
import com.elisoft.aramscruz.perfil.Mis_direcciones;
import com.elisoft.aramscruz.perfil.Perfil_pasajero;
import com.elisoft.aramscruz.preregistro.Verificar_numero;
import com.elisoft.aramscruz.registro_inicio_sesion.Animacion;
import com.elisoft.aramscruz.reserva.Historial_reserva;
import com.elisoft.aramscruz.tarifario.Tarifa;
import com.elisoft.aramscruz.viajes.Viajes;
        ...
        if(version>actual)
        {
            try {
                ...
                dialogo1.setPositiveButton("ACTULIZAR", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogo1, int id) {
                        Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=com.elisoft.aramscruz");
