...
import com.elisoft.aramscruz.carreras.Carreras;
...
public class Viajes extends AppCompatActivity {
    ...
    public void lista_por_mes(String s_mes)
    {
        ...
        String url=ip+"frmPedido.php?opcion=lista_pedido_por_id_usuario_mes";
    ...
    public void actualizar()
    {
        ...
        */
        String url=ip+"frmPedido.php?opcion=lista_pedido_por_id_usuario_top50";
        JSONObject jsonParam = new JSONObject();
    ...
    private void ver_video(CViajes viaje) {
        ...
        try {
            Intent i = new Intent(getApplicationContext(), Carreras.class);
